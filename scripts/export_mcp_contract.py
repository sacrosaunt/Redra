...
def contract() -> dict:
    ...
    return {
        "schema": "redra-mcp-tool-contract/v2",
        "compatibility": (
            ...
            "may be released within v2 after client regression testing."
        ),
        "tools": [
            {
                "name": tool.name,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Export Redra's frozen MCP v2 contract")
